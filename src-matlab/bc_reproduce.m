...
function [new_population,updated_species_record,updated_innovation_record]=bc_reproduce(population, species_record, innovation_record, initial, selection, crossover, mutation, speciation, generation, population_size);
...
for index_species=1:size(matrix_existing_and_propagating_species,2)
   ...
   while matrix_existing_and_propagating_species(3,index_species)<matrix_existing_and_propagating_species(2,index_species) %cycle until actual number of offspring has reached allotted number of offspring                                                          
      ...
      %new_population
      %new_population.nodegenes
      %new_population.connectiongenes
      %new_individual
      %new_individual.nodegenes
      %new_population.connectiongenes
      %pause;
...
%assign updated spe.cies_record to output
